package frc.robot.pathing.robotprofile;

public class Motor {
  private double stallTorque, freeSpeed;

  /**
   * Constructs a custom motor. In most cases, you should be able to just use {@link Motor#CIM()},
   * {@link Motor#NEO()}, {@link Motor#FALCON()}, {@link Motor#VORTEX()}, or {@link
   * Motor#KRAKENX60()}, and then use the {@link #gear()} method to get it in the correct gear. If
  ...
  /**
   * Gears this motor with the given gear ratio.
   *
   * @param gearRatio The gear ratio can be a custom one (given as a double), but in most cases, a
